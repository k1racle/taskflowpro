window.TaskFlowShellNavigationMeta = (function () {
    const NAV_ITEMS = [
        ...
        { id: 'crm-store', label: 'Интернет-магазин', icon: 'M3 7h18l-2 11H5L3 7zm4-4h10l1 4H6l1-4zm2 9h2m4 0h2', badge: '', visible() { return !!this.canCrm; } },
    ...
    const GROUP_VIEW_IDS = {
        workspace: ['projects', 'departments', 'leader-dashboard', 'helpdesk', 'my-shift'],
    ...
    return {
        ...
        getMobileContextTag(ctx) {
            ...
            if (['chat', 'conferences', 'helpdesk', 'my-shift'].includes(currentView)) return 'Коммуникации';
            ...
            return [
                {
                    ...
                    items: nav.filter((item) => GROUP_VIEW_IDS.workspace.includes(item.id))
                },
                {
                    id: 'resources',
